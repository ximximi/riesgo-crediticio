...
def inyectar_tablas_limpias(df, engine):
    ...
    df_cliente.to_sql('cliente_limpio', engine, if_exists='append', index=False, chunksize=5000)
    ...
    df_prestamo.to_sql('prestamo_limpio', engine, if_exists='append', index=False, chunksize=5000)
